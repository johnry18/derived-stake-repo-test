export default {
	...
	bg_preloader_portrait: {
		type: 'sprite',
		src: new URL('../../assets/sprites/background/preloader-bg-portrait.jpg', import.meta.url).href,
		preload: true,
	},
	bg_preloader_landscape: {
		type: 'sprite',
		src: new URL('../../assets/sprites/background/preloader-bg-landscape.jpg', import.meta.url)
			.href,
		preload: true,
	},
	bg_main_portrait: {
		type: 'sprite',
		src: new URL('../../assets/sprites/background/main-bg-portrait.jpg', import.meta.url).href,
		preload: true,
	},
	bg_main_landscape: {
		type: 'sprite',
		src: new URL('../../assets/sprites/background/main-bg-landscape.jpg', import.meta.url).href,
		preload: true,
	},
	symbol: {
		type: 'sprites',
		src: new URL('../../assets/sprites/symbolsStatic/symbol.json', import.meta.url).href,
	},
	winframe: {
		type: 'spine',
		src: {
			atlas: new URL('../../assets/spines/winFrame/win.atlas', import.meta.url).href,
			skeleton: new URL('../../assets/spines/winFrame/win.json', import.meta.url).href,
		},
	},
	reelsFrame: {
		type: 'sprites',
	...
	logo: {
		type: 'sprites',
		src: new URL('../../assets/sprites/logo/logo.json', import.meta.url).href,
	},
	sound: {
		type: 'audio',
